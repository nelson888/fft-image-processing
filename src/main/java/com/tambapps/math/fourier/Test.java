...
import com.tambapps.math.fourier.fft_2d.FastFourierTransformer;
...
/*
        FastFourierTransformer fftt = new FastFourierTransformer(executorService, maxThreads);

        Complex[][] a = fftt.transform(ImageConverter.toArray2(ImageIO.read(new File("/home/fonkoua/Téléchargements/imgres_000.jpg"))));
        ImageIO.write(ImageConverter.fromArray2(a, BufferedImage.TYPE_INT_RGB), "jpg", new File("/home/fonkoua/Téléchargements/dft_original.jpg"));
*/
